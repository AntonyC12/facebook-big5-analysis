...
def main():
    ...
    try:
        ...
        print(f"✅ Scraping completado en {format_duration(time.time() - scrape_start)}")
        ...
        print(f"✅ Análisis en español completado en {format_duration(time.time() - analysis_start)}")
